...
public class ChoiceApplet extends Applet implements ItemListener
{
  ...
  Choice colorchoice;
  Color color;
  int fontsize=8;  // the variable that stores the font size
  ...
  public void init()
  {
    ...
    colorchoice.addItem("Magenta"); // new color
    colorchoice.addItem("Cyan"); // new color
    add(colorchoice);
  ...
  public void itemStateChanged(ItemEvent e)
  {
    ...
    {
      fontsize=(c.getSelectedIndex() + 1)* 8; // change the font size
  ...
  public void handleMenu(String selectedcolor)
  {
      ...
      else if(selectedcolor=="Magenta") color=color.magenta; // new item
      else if(selectedcolor=="Cyan") color=color.cyan; // new item
    repaint();
  }
